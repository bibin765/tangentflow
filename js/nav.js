    ...
    footerEl.innerHTML = `
      <footer class="site-footer">
        <div class="footer-inner">
          <span class="footer-text">TangentFlow &mdash; Pixel-perfect PDF generation, powered by Pretext. &nbsp;<a href="${prefix}privacy.html" style="color:inherit;text-decoration:underline;text-underline-offset:2px;">Privacy</a> &nbsp;<a href="${prefix}security.html" style="color:inherit;text-decoration:underline;text-underline-offset:2px;">Security</a></span>
          <ul class="footer-links">
            <li><a href="https://github.com/bibin765/tangentflow" target="_blank" rel="noopener" aria-label="GitHub">
